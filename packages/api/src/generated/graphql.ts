...
export type ConsentResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['Consent'] = ResolversParentTypes['Consent']
> = {
...
export type ConsentResponseResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['ConsentResponse'] = ResolversParentTypes['ConsentResponse']
> = {
    user?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type HellowWorldDataResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['HellowWorldData'] = ResolversParentTypes['HellowWorldData']
> = {
...
> = {
    addConsent?: Resolver<
        Maybe<ResolversTypes['ConsentResponse']>,
        ParentType,
        ContextType,
        RequireFields<MutationAddConsentArgs, 'type'>
    >;
    register?: Resolver<
    ...
    >;
    registerUserFromExternalProvider?: Resolver<
        Maybe<ResolversTypes['User']>,
        ParentType,
        ContextType,
        RequireFields<MutationRegisterUserFromExternalProviderArgs, never>
    >;
    updateUserProfileImage?: Resolver<
        Maybe<ResolversTypes['User']>,
        ParentType,
        ContextType,
        RequireFields<MutationUpdateUserProfileImageArgs, 'file'>
    >;
};
